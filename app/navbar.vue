            ...
            <nav class="uk-navbar">
                ...
                <div class="uk-navbar-right">
                    ...
                    <div class="uk-navbar-item uk-visible@m">
                        <router-link class="uk-button uk-button-default tm-button-default uk-icon" to="/download" active-class="page-active">Download as PDF<canvas uk-icon="icon: download" width="20" height="20"></canvas>
                        </router-link>
                    </div>
