            ...
            <div class="uk-width-1-1">
                <div class="uk-container">
                    ...
                    <p class="uk-margin-medium uk-text-lead">
                        Jinの作ったC++教本<br class="uk-visible@s">
        ...
        <div class="uk-section-small">
            <div class="uk-container uk-container-expand uk-text-center uk-position-relative">
                ...
                <ul class="uk-subnav tm-subnav uk-flex-inline uk-flex-center uk-margin-remove-bottom" uk-margin>
                    ...
                    <li>
                        <a class="uk-text-lowercase" href="https://twitter.com/CPP_IS_GOD"><span class="uk-margin-small-right" uk-icon="icon: twitter"></span>@CPP_IS_GOD</a>
                    </li>
                    <li>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            ajax('https://api.github.com/repos/Jin3004/cppbook', {responseType: 'json'}).then(({response}) => {
